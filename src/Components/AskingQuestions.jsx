...
const AskingQuestions = () => {
  ...
  const [userWake, setUserWake] = useState("");
  const [cpuResponse, setCpuResponse] = useState("");
    

const askQuestion = async () => {

  if (userName == "" || userWake =="")
  {

  }
  else
  {
    setCpuResponse(await AskFetch(userName, userWake))
  }
...
{/* <!-- Nav --> */}
    <nav className="w-full h-[65px] bg-[#1765FF] flex relative py-1">
        ...
        <p className="text-center text-white font-bold text-[25px] sm:text-[40px] self-center mb-0 ms-3 ">Asking Questions</p>
    ...
    <div className="h-full w-full flex">
        ...
        <div className=" h-full w-[23%] hidden md:block">
            ...
            <div className="flex py-2">
                ...
                <p className="text-center font-bold text-[25px] self-center mb-0 ms-3 ">Asking Questions</p>
            </div>
        ...
        <div className=" h-full w-full md:w-[76%] grid grid-cols-[16.67%_16.67%_16.67%_16.67%_16.67%_16.67%] grid-rows-[14.29%_14.29%_14.29%_14.29%_14.29%_14.29%_14.29%]">
            {/* <!-- user Input fields --> */}
           <input onChange={(e) => setUserName(e.target.value)} placeholder="My name is" type="text" className="bg-white h-[50%] w-full sm:w-[80%] col-start-2 row-start-2 col-end-6 self-center justify-self-center border-1 inset-shadow-sm rounded-[5px] text-center text-[40px] font-bold" />
       
            <p className="m-0 col-start-2 col-end-6 row-start-1 text-center self-center font-bold text-[30px] sm:text-[50px]">What is your name?</p>

           <input onChange={(e) => setUserWake(e.target.value)} placeholder="I woke up at" type="text" className="bg-white h-[50%] w-full sm:w-[80%] col-start-2 col-end-6 row-start-4 self-center justify-self-center border-1 inset-shadow-sm rounded-[5px] text-center text-[40px] font-bold"/>

           <p className="m-0 col-start-2 col-end-6 text-center row-start-3 self-center font-bold text-[30px] sm:text-[50px]">What time did you wake up?</p>
            {/* <!-- response --> */}
           
            <div className="col-start-2 col-end-6 text-center row-start-5 self-center h-full w-full flex justify-center">
                <div className="bg-white w-[100%] h-[100%] self-center rounded-[7px] border-x-4 border-b-4 border-[#0B44FF]">
                    <h2 className="bg-[#0B44FF] text-white font-bold py-1 rounded-t-[5px]">Computer</h2>
                        ...
                        <div className="h-[90%]  place-content-center overflow-y-auto">
                            <p id="cpuResponse" className="self-center text-[40px] font-bold mb-2">{cpuResponse}</p>
                        </div>
