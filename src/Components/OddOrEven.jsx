...
const OddOrEven = () => {
    ...
    const OddOrEvemFunc = async () => {
      ...
      {
          setCpuResponse(await oddFetch(userInput))
      }
      ...
      <div className="h-full w-full flex">
        ...
        <div className=" h-full w-full md:w-[76%] grid grid-cols-[16.67%_16.67%_16.67%_16.67%_16.67%_16.67%] grid-rows-[14.29%_14.29%_14.29%_14.29%_14.29%_14.29%_14.29%]">
          ...
          <input
            ...
            type="text"
            className="bg-white h-[50%] w-full sm:w-[80%] col-start-2 row-start-5 col-end-6 self-center justify-self-center border-1 inset-shadow-sm rounded-[5px] text-center text-[40px] font-bold"
          />

          <p className="m-0 col-start-2 col-end-6 row-start-1 row-end-3 text-center self-center font-bold text-[30px] md:text-[40px]">
            Give me a number, I’ll tell you if it’s odd or even
          </p>
          ...
          <div className="col-start-2 col-end-6 text-center row-start-3 row-end-5 self-center h-full w-full flex justify-center">
            <div className="bg-white w-[100%] h-[100%] self-center rounded-[7px] border-x-4 border-b-4 border-[#0B44FF]">
              ...
              <div className="h-[90%]  place-content-center overflow-y-auto">
                <p
                  id="cpuResponse"
                  className="self-center text-[60px] font-bold mb-2"
                >{cpuResponse}</p>
              </div>
            </div>
          </div>
