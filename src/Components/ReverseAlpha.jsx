...
import { reverseAlphaFetch } from "../Services/DataService.js";
...
const ReverseAlpha = () => {
        ...
        const ReverseAlphaFunc = async () => {
            ...
            {
                setCpuResponse(await reverseAlphaFetch(userInput))
            }
    ...
    <div className="h-full w-full flex">
        ...
        <div className=" h-full w-full md:w-[76%] grid grid-cols-[16.67%_16.67%_16.67%_16.67%_16.67%_16.67%] grid-rows-[14.29%_14.29%_14.29%_14.29%_14.29%_14.29%_14.29%]">
            {/* <!-- user Input fields --> */}
           <input onChange={(e) => setUserInput(e.target.value)} placeholder="My word is" type="text" className="bg-white h-[50%] w-full sm:w-[80%] col-start-2 row-start-5 col-end-6 self-center justify-self-center border-1 inset-shadow-sm rounded-[5px] text-center text-[40px] font-bold" />
       
            <p className="m-0 col-start-2 col-end-6 row-start-1 row-end-3 text-center self-center font-bold text-[30px] md:text-[40px]">Give me a word, I’ll reverse it for you</p>
