...
const GreaterThanLessThan = () => {
    ...
    const GTLT = async () => {
        ...
        {
            setCpuResponse(await GTLTFetch(userNum1, userNum2))
        }
    ...
    <nav className="w-full h-[65px] bg-[#1765FF] flex relative py-1">
        ...
        <p className="text-center text-white font-bold text-[25px] sm:text-[40px] self-center mb-0 ms-3 ">GTLT</p>
    ...
    <div className="h-full w-full flex">
        ...
        <div className=" h-full w-[23%] hidden md:block">
            ...
            <div className="flex py-2">
                ...
                <p className="text-center font-bold text-[25px] self-center mb-0 ms-3 ">GTLT</p>
            </div>
        ...
        <div className=" h-full w-full md:w-[76%] grid grid-cols-[16.67%_16.67%_16.67%_16.67%_16.67%_16.67%] grid-rows-[16.67%_16.67%_16.67%_16.67%_16.67%_16.67%]">
            ...
            {/* <!-- inputs --> */}
           <input onChange={(e) => setUserNum1(e.target.value)} type="text" className="bg-white h-[50%] w-full sm:w-[90%] col-start-2 col-end-6 md:col-start-3 md:col-end-5 row-start-2  self-center justify-self-center border-1 inset-shadow-sm rounded-[5px] text-center text-[40px] font-bold" />
       
            <p className="m-0 row-start-1 col-start-2 col-end-6 text-center self-center font-bold text-[40px] sm:text-[50px]">Give me two numbers </p>

           <input onChange={(e) => setUserNum2(e.target.value)} type="text" className="bg-white h-[50%] w-full sm:w-[90%] col-start-2 col-end-6  md:col-start-3 md:col-end-5 row-start-4  self-center justify-self-center border-1 inset-shadow-sm rounded-[5px] text-center text-[40px] font-bold"/>


            {/* <!-- Response --> */}
            <div className="col-start-2 col-end-6  md:col-start-3 md:col-end-5 text-center row-start-3 self-center h-full w-full flex justify-center">
                <div className="bg-white w-[90%] h-[90%] self-center rounded-[7px] border-x-4 border-b-4 border-[#0B44FF]">
                    <h2 className="bg-[#0B44FF] text-white font-bold py-1 rounded-t-[5px]">Computer</h2>
                        ...
                        <div className="h-[90%]  place-content-center overflow-y-auto">
                            <p id="response" className="self-center text-[40px] font-bold mb-2">{cpuResponse}</p>
                        </div>

                </div>
            </div>
           <p id="totalNum" className="m-0 col-start-3 col-end-5 text-center row-start-4 self-center font-bold text-[50px]"></p>


           <button onClick={GTLT} className="col-start-3 col-end-5 text-center row-start-5 h-25 self-center bg-[#DCD7B5] rounded-[5px] border-t-2 border-t-white  border-s-2 border-s-white border-b-2 border-b-black  border-e-2 border-e-black text-[30px] sm:text-[45px]  font-extrabold active:border-t-black active:border-s-black active:border-e-white active:border-b-white">Magic</button>
