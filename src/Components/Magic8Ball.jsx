...
const Magic8Ball = () => {
    ...
    <nav className="w-full h-[65px] bg-[#1765FF] flex relative py-1">
        ...
        <p className="text-center text-white font-bold text-[25px] sm:text-[40px] self-center mb-0 ms-3 ">Magic 8 ball</p>
    ...
    <div className="h-full w-full flex">
        ...
        <div className=" h-full w-[23%] hidden md:block">
            ...
            <div className="flex py-2">
                ...
                <p className="text-center font-bold text-[25px] self-center mb-0 ms-3 ">Magic 8 Ball</p>
            </div>
